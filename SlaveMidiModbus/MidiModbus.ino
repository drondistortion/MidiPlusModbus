...
void loop()
{
	...
	byte bd_button =  PINB & 0b00000001;
	byte sn_button =  PIND & 0b00010000; 
	byte sn_button2 = PIND & 0b01000000;

	// assign the buttonState value to the holding register
	holdingRegs[BD_BUTTON1_STATE] = !bd_button;
	holdingRegs[SN_BUTTON2_STATE] = !sn_button;
	holdingRegs[SN_BUTTON3_STATE] = !sn_button2;
